...
// CONFIG2L
#pragma config MCLRE = INTMCLR  // MCLR Enable bit->If LVP = 0, MCLR pin function is port defined function; If LVP =1,
                                // RE3 pin fuction is MCLR
...
// CONFIG2H
// #pragma config BORV = VBOR_2P45 // Brown-out Reset Voltage Selection bits->
// Brown-out Reset Voltage (VBOR) set to 2.45V
#pragma config ZCD = OFF     // ZCD Disable bit->ZCD disabled. ZCD can be enabled by setting the ZCDSEN bit of ZCDCON
#pragma config PPS1WAY = OFF // PPSLOCK bit One-Way Set Enable bit->PPSLOCK bit can be set and cleared repeatedly
                             // (subject to the unlock sequence)
